...
UBTT_GetStrafeTarget::UBTT_GetStrafeTarget()
{
...
EBTNodeResult::Type UBTT_GetStrafeTarget::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
